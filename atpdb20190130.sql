create schema if not exists ATPDB collate utf8_general_ci;

use ATPDB;

create table if not exists ATP_email
(
...
create table if not exists ATP_log
(
...
create table if not exists ATP_pkg
(
	id bigint auto_increment comment 'id'
		primary key,
...
create table if not exists ATP_pkgCfg
(
...
create table if not exists ATP_plan
(
	id bigint auto_increment comment 'ID'
		primary key,
...
create table if not exists ATP_task
(
	id bigint auto_increment comment 'ID'
		primary key,
	name varchar(256) default '' not null comment '名称',
...
create table if not exists ATP_taskResult
(
	id bigint auto_increment comment 'id'
		primary key,
...
create index ATP_taskResult_planId_index
	on ATP_taskResult (planId);

create index ATP_taskResult_taskId_index
	on ATP_taskResult (taskId);

create table if not exists ATP_taskResultDetail
(
	id bigint auto_increment comment 'id'
		primary key,
...
create table if not exists ATP_taskSet
(
	id int not null
		primary key,
...
create table if not exists ATP_tc
(
	id bigint auto_increment comment 'ID'
		primary key,
...
create table if not exists ATP_tcs
(
