...
public class SysFreePort {
    private static final Logger LOGGER = LoggerFactory.getLogger(SysFreePort.class);
    ...
    public static int getFreePort() throws IOException {
        SysFreePort sysFreePort = SysFreePort.custom();
        int freePort = sysFreePort.getPortAndFree();
        LOGGER.info("return free port:{}", freePort);
        return freePort;
    }
}